...
import { ChainReport, WarningIndicators } from 'src/app/models/chain-report.model';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatCardModule, MatTableModule, MatIconModule], // Add MatIconModule here
...
export class OnchainMetricsSectionComponent {
  ...
  getRiskLevelIcon(riskLevel: WarningIndicators['riskLevel']): string {
    switch (riskLevel) {
      case 'low':
        return 'check_circle';
      case 'medium':
